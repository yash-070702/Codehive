...
export const Particles = ({
  ...
  const resizeCanvas = () => {
    if (canvasContainerRef.current && canvasRef.current && context.current) {
      // Use offsetWidth and offsetHeight to ensure full container coverage
      const parentElement = canvasContainerRef.current.parentElement;
      const containerWidth = parentElement ? parentElement.offsetWidth : window.innerWidth;
      const containerHeight = parentElement ? parentElement.offsetHeight : window.innerHeight;
